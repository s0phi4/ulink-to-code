...
/***/ function(module, exports, __webpack_require__) {
	...
	var resourceEvents = __webpack_require__(12);
	//
	// On document ready
	$(function () {
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://yenproject.herokuapp.com',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(ui.successSignUp).catch(ui.failureSignUp);
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(function (response) {
	    ...
	    return store;
	  }).then(ui.successSignIn).catch(ui.failureSignIn);
	};

	var onChangePassword = function onChangePassword(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.changePassword(data).then(ui.successChangePassword).then(function () {
	...
	var onSignOut = function onSignOut(event) {
	  event.preventDefault();
	  api.signOut().then(ui.successSignOut);
	  // .catch(ui.failureSignOut);
	};
	var onClean = function onClean() {
	  $('.clean-change').val('');
	  $('#messagePass').text('');
	};

	var onCleanSignup = function onCleanSignup() {
	  $('.signup-clean').val('');
	  $('.message').text('');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(6);
	var linkEvents = __webpack_require__(12);
	...
	var failureSignUp = function failureSignUp() {
	  $('.signup-clean').val('');
	  $('.message').text('Nope, you used this account already, try with a different account!');
	};

	var successSignIn = function successSignIn(data) {
	  config.user = data.user;
	  $('#sign-up').val('');
	  $('.clean-signin').val('');
	...
	var failureSignIn = function failureSignIn(error) {
	  if (error) {
	    $('.message_two').text('Nope, please use the right email and password');
	  }
	};

	var succesChangePassword = function succesChangePassword() {
	  $('#messagePass').text('Great! Change is successful!');
	};

	var successSignOut = function successSignOut() {
	  $('.container_for_info').hide();
	  $('.go_to_data').hide();
	  $('.pass').hide();
	  $('.sign-out').hide();
	...
	var failureSignOut = function failureSignOut() {
	  $('.container_for_info').hide();
	  $('.go_to_data').hide();
	  $('.pass').hide();
	  $('.sign-out').hide();
	...
	module.exports = {
	  failureSignUp: failureSignUp,
	  successSignUp: successSignUp,
	  successSignIn: successSignIn,
	  failureSignIn: failureSignIn,
	  succesChangePassword: succesChangePassword,
	  successSignOut: successSignOut,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(8);
	var api_link = __webpack_require__(13);
	var ui_link = __webpack_require__(14);

	var onGetLinks = function onGetLinks(event) {
	  if (event) {
	    event.preventDefault();
	  }
	  $('.resourcesTable').show();
	  api_link.getLinks().then(function (resources) {
	    ui_link.showUserResources(resources);
	  }).catch(ui_link.failure);
	};

	var onCreateLink = function onCreateLink(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api_link.createLink(data).then(ui_link.successSave).then(onGetLinks).catch(ui_link.failure);
	};

	var onUpdateLink = function onUpdateLink(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var id = $(event.target).data('id');
	  api_link.updateLink(data, id).then(function () {
	    ui_link.onUpdateSuccess(id);
	  }).then(onGetLinks).catch(ui_link.failure);
	};

	var onDeleteLink = function onDeleteLink(event) {
	  event.preventDefault();
	  var id = $(event.target).data('id');
	  api_link.deleteLink(id).then(ui_link.success).then(onGetLinks).catch(ui_link.failure);
	};

	var linkHandlers = function linkHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//create link
	var createLink = function createLink(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/resources',
	    method: 'POST',
	    headers: {
	...
	var updateLink = function updateLink(data, id) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateSuccess = function onUpdateSuccess(id) {
	...
	var successSave = function successSave(data) {
	  config.resource = data.resource;
	  $('.clean-info').val('');
	};
	var successChange = function successChange(data) {
	  config.resource = data.resource;
	};

	var showUserResources = function showUserResources(data) {
	  var resourceTemplate = __webpack_require__(15);
	...
	module.exports = {
	  ...
	  showUserResources: showUserResources
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr>\n        <td data-id=\""
	    ...
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content_type : stack1), depth0))
	    + "</td>\n        <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tag : stack1), depth0))
	    + "</td>\n        <td>\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger delete_information\">\n            <span data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"glyphicon glyphicon-trash\"></span>\n          </button>\n\n\n          <button type=\"button\"\n            class=\"btn btn-primary btn pull-right update\"\n            data-toggle=\"modal\"\n            data-target=\"#exampleModalUpdate-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"\n            data-whatever=\"@getbootstrap\">\n            <span data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"glyphicon glyphicon-pencil\"></span>\n          </button>\n          <div class=\"modal updateRowTable\" id=\"exampleModalUpdate-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\">\n            <div class=\"modal-dialog\" role=\"document\">\n              <div class=\"modal-content saveNewLink\">\n                <div class=\"modal-header\">\n                  <form data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-info\">\n                    <fieldset>\n                      <h4 class=\"modal-title\" id=\"exampleModalLabel-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update!</h4>\n                      <label>\n                          Name\n                          <input type = \"name\" name =\"resource[name]\" required>\n                      </label>\n                      <label>\n                          URL\n                          <input type =\"url\" name =\"resource[url]\" required>\n                      </label>\n                      <input type=\"submit\" class=\"btn btn-primary uInfo\" name=\"submit\" value=\"Save\">\n                      <div id=\"messageUpdate-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"></div>\n                    </fieldset>\n                  </form>\n                </div>\n              </div>\n            </div>\n          </div>\n      </td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<h1 class=\"title\">UCode-My Online Resources!</h1>\n\n\n<table class=\"table coding-resources\">\n  <thead>\n      <tr>\n        <th class= \"hide-id\">ID</th>\n        <th>Name</th>\n        <th>URL</th>\n        <th>Content-Type</th>\n        <th>Tag</th>\n      </tr>\n    </thead>\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.resources : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </tbody>\n</table>\n";
